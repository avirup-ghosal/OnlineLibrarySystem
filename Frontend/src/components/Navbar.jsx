...
export default function Navbar(data) {
  ...
  const [nameList,setNameList]=useState([])
    ...
    <div style={{backgroundColor:"beige",border:"solid"}}>
        ...
        <span  style={{fontSize:"1.25rem",color:"black",display:"flex",textDecorationColor:"#2a255a",marginLeft:"10px",marginRight:"0px",fontWeight:"700",alignItems:"center",justifyContent:"flex-start"}}className="text-xl flex text-#2a255a mx-3 font-bold items-center"><Link style={{color:"#2a255a",textDecoration:"none",fontFamily:"monospace",fontSize:"19px"}} to="/home">InfiniteLibrary</Link></span>
        <ul style={{listStyle:"none",paddingLeft:"0rem",paddingRight:"5rem",paddingTop:"1.5rem",paddingBottom:"1.5rem",display:"flex",justifyContent:"flex-end",marginRight:"4.75rem",marginLeft:"600px",alignItems:"center"}} className="px-28 py-4 flex space-x-11 justify-end">
